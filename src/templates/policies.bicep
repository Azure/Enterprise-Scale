...
var loadPolicyDefinitions = {
  All: [
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Append-Synapse-Purview.json')
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Cosmos-Cors.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Cosmos-KeyBasedMetadataWriteAccess.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataExplorer-Sku.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataExplorer-TrustedExternalTenants.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataFactory-ApiVersion.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataFactory-IdentityType.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataFactory-IntegrationRuntimeManagedVirtualNetwork.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataFactory-ManagedPrivateEndpoints.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-DataFactory-PublicNetworkAccess.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-EventHub-IpFilterRules.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-EventHub-MaximumThroughputUnits.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-EventHub-NetworkRuleSet.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-EventHub-Sku.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-EventHub-VNetRules.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-HdInsight-MinimalTlsVersion.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-HdInsight-NetworkProperties.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-HdInsight-Sku.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-IotHub-MinimalTlsVersion.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-IotHub-Sku.json')
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Search-PublicNetworkAccess.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Search-Sku.json')
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-StreamAnalytics-ClusterId.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-StreamAnalytics-StreamingUnits.json')
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-Firewall.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-LinkedAccessCheckOnTargetResource.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-Spark-AutoPause.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-Spark-AutoScale.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-Spark-ComputeIsolation.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-Spark-DefaultSparkLogFolder.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deny-Synapse-Sql-Sku.json')
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-DataFactory-ManagedVnet.json')
    ...
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-AuditingSettings.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-Sql-AuditingSettings.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-Sql-MetadataSync.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-Sql-SecurityAlertPolicies.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-Sql-TransparentDataEncryption.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-Sql-VulnerabilityAssessment.json')
    loadTextContent('../resources/Microsoft.Authorization/policyDefinitions/Deploy-Synapse-VulnerabilityAssessment.json')
