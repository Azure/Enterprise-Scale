...
* 3 (Optional) Enable Diagnostic Policy to enable monitoring.
    ...
    To execute those steps, you will assign policies to the **ES-management** Management Group. In a real customer environment, some policies are assigned to **Connectivity** and **Landing Zones** Management Group scopes.

* 4 Author policy assignment ARM template to declare goal state of **connectivity** subscription.
    a. Create vWAN
    b. Create Firewall Policy
    c. Create vHUB

Please note that steps 4 will cause additional cost on your subscription.

## (Optional) Assign the Log Analytics policy

Only execute this section in case you select No to create management resources in the [Deploy the Management Group structure and policy/PolicySet definitions](./deploy-tenant.md#deploy-the-management-group-structure-and-policypolicyset-definitions) section.
...
In this section, we will focus on enabling networking for landing zones. In our example, we only have a single subscription in the **ES-management** Management Group. In customer's environment, you would assign these policies at the **Connectivity** Management Group scope.
...
1. Assign the **Deploy-vWAN** and **Deploy-FirewallPolicy** policies to the **ES-management** Management Group:
    ...
    ![_Figure_](./media/wt-3.3-1.png "Figure" =60%x)
    ...
    ![_Figure_](./media/wt-3.3-3.png "Figure" =60%x)
...
2. Assign the **Deploy-vHUB** policy to the **ES-management** Management Group:
    ...
    ![_Figure_](./media/wt-3.3-5.png "Figure" =60%x)
