...
As part of this release we introducing the Policy Testing Framework foundation, along with tests for all assigned infrastructure policies. This will allow us to test the policies in a more automated fashion, and will help us to ensure that we don't introduce any regressions in the future. We will be adding tests for custom policies in the future.
