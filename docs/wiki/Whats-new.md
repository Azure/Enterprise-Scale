...
- Updated the policy assignment parameters for [Private DNS Zones](https://www.azadvertizer.net/azpolicyinitiativesadvertizer/Deploy-Private-DNS-Zones.html) initiative to include new Azure regions launched since the last update.
