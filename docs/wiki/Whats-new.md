...
- New Initiative for the Decommissioned landingzone including policies:
  - Initiative name: Enforce-LZ-Decomm.json
...
- New Initiative for the Sandboxes landingzone including policies:
  - Initiative name: Enforce-LZ-Sanbox.json
