...
- Added new custom policy [Audit-Tags-Mandatory](https://www.azadvertizer.net/azpolicyadvertizer/Audit-Tags-Mandatory.html) to support auditing resource groups for the existence of mandatory tags (based on an array of tags). Not assigned by default.
