...
* [Azure Monitor Baseline Alerts](./Azure-Monitor-Baseline-Alerts)
...
* Deploying Azure Monitor Baseline Alerts
  * [Introduction to deploying AMBA](./Introduction-to-deploying-AMBA)
  * [Customize Policy Assignment](./Customize-AMBA-Policy-Assignment)
  ...
  * [Policy remediation](./Remediate-AMBA-Policies)
  * [Cleaning up an ALZ Monitor Deployment](./Cleaning-up-an-AMBA-Deployment)
