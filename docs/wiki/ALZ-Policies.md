...
> <a href=./media/ALZ%20Policy%20Assignments%20v2.xlsx><img src=./media/ef73.svg width=64 height=64 align=center></a> For convenience, an Excel version of the below information is available [here](./media/ALZ%20Policy%20Assignments%20v2.xlsx) or click the icon (last updated April 2023).
