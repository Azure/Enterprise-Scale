...
| **Enable Azure Monitor for VMs with Azure Monitoring Agent(AMA)**                                           | **[Preview]: Enable Azure Monitor for VMs with Azure Monitoring Agent(AMA)**                                                 | `Policy Definition Set`, **Built-in** | Enable Azure Monitor for the virtual machines (VMs) with AMA. Takes Log Analytics workspace as parameter and asks for an option to enable Processes and Dependencies. | DeployIfNotExists |
| **Enable Azure Monitor for Hybrid VMs with AMA**                    | **[Preview]: Enable Azure Monitor for Hybrid VMs with AMA**                          | `Policy Definition Set`, **Built-in** | Enable Azure Monitor for the hybrid virtual machines with AMA. Takes Log Analytics workspace as parameter and asks for an option to enable Processes and Dependencies.          | DeployIfNotExists |
| **Enable Azure Monitor for VMSS with Azure Monitoring Agent(AMA)**                    | **[Preview]: Enable Azure Monitor for VMSS with Azure Monitoring Agent(AMA)**                          | `Policy Definition Set`, **Built-in** | Enable Azure Monitor for the virtual machines scale set (VMSS) with AMA. Takes Log Analytics workspace as parameter and asks for an option to enable Processes and Dependencies.          | DeployIfNotExists |
