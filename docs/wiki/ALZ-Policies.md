...
| **Audit Private DNS Zone resources**          | **Not allowed resource types**          | `Policy Definition`, **Built-in**     | Audits the deployment of Private DNS Zone resources in the Corp landing zone.                                                                                                                                         | Audit              | 1.0.0   |
