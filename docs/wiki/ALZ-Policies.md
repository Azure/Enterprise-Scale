...
For convenience, an Excel version of the below information is available [here](media/ALZ%20Policy%20Assignments%20v1.xlsx) (last updated January 2023).
...
| **RDP access from the Internet should be blocked**                                                                  | **RDP access from the Internet should be blocked**                                                                  | `Policy Definition`, **Custom**   | This policy denies any network security rule that allows RDP access from Internet.                                                             | Deny              |
...
| **Prevent usage of Databricks with public IP**                 | **Deny public IPs for Databricks cluster**                     | `Policy Definition`, **Custom**     | Denies the deployment of workspaces that do not use the noPublicIp feature to host Databricks clusters without public IPs.                                                                             | Deny              |
| **Enforces the use of Premium Databricks workspaces**          | **Deny non-premium Databricks sku**                            | `Policy Definition`, **Custom**     | Enforces the use of Premium Databricks workspaces to make sure appropriate security features are available including Databricks Access Controls, Credential Passthrough and SCIM provisioning for AAD. | Deny              |
| **Enforces the use of vnet injection for Databricks**          | **Deny Databricks workspaces without Vnet injection**          | `Policy Definition`, **Custom**     | Enforces the use of vnet injection for Databricks workspaces.                                                                                                                                          | Deny              |
