...
| **Deny virtual machines and virtual machine scale sets not using managed disk** | **Deny virtual machines and virtual machine scale sets not using managed disk** | `Policy Definition`, **Custom**     | Deny virtual machines not using managed disk. It checks the managedDisk property on virtual machine OS, and Datadisk fields.                                                                                                                                                                                                                         | Deny                   | 1.0.0   |
