...
| **Deny Virtual Machines and Virtual Machine Scale Sets from not using Managed Disks** | **Deny Virtual Machines and Virtual Machine Scale Sets from not using Managed Disks** | `Policy Definition`, **Custom**     | Deny virtual machines not using managed disk. It checks the managedDisk property on virtual machine OS, and Datadisk fields.                                                                                                                                                                                                                         | Deny                   | 1.0.0   |
